...
//TEST OFFICIER LANG
$lang['tn_commandant_name']					= "NGClasic Commander";
$lang['tn_admiral_name']					= "Admiral";
$lang['tn_ingeniuer_name']					= "Engineer";
$lang['tn_geologue_name']					= "Geologist";
$lang['tn_tecnokrate_name']					= "Technocrat";
$lang['tn_admiral_info']					= "+2 max. fleet slots";
$lang['tn_ingeniuer_info']					= "Minimizes losses in half defenses,&lt;br&gt;+10% energy production";
$lang['tn_geologue_info']					= "+10% mine production";
$lang['tn_tecnokrate_info']					= "+2 Espionage level,&lt;br&gt;-25% Less time for research";
$lang['tn_active_now']						= "Get now!";
//----------------------------------------------------------------------------//
//LEFT MENU
...
$lang['lm_officiers']						= 'Officers Recruitment';
...
$lang['ov_text']							= 'NGClasic is looking for leaders...';
$lang['ov_text_sub']						= '...get commander!';
...
$lang['bd_description']						= 'Description';
$lang['bd_amount']							= 'Amount';
$lang['bd_work_todo']            			= 'Building queue';
//----------------------------------------------------------------------------//
//RESOURCES
...
$lang['of_dm_improves']						= "Dark Matter can be used to hire Officers and Commanders as well as pay for merchant offers";
$lang['of_dm_description']					= 'Dark Matter is a substance for which storage has only been possible for a few standard years and still requires a lot of effort. It can be processed to produce unimaginable quantities of energy. The methods used to gain Dark Matter are complex and full of risks, making it very valuable.';
$lang['of_dm_buy']							= 'Purchase Dark Matter';
$lang['of_time_for']						= 'for';
$lang['of_time_months']						= '3 months';
$lang['of_time_weeks']						= '1 Week';
//----------------------------------------------------------------------------//
//TRADER
...
$lang['tr_not_put_necessaire']				= 'You have to put resources to exchange';
//----------------------------------------------------------------------------//
//TECHTREE
$lang['tt_requirements']					= 'Requirements';
$lang['tt_lvl']								= 'level ';
$lang['tt_for_build']						= 'Conditions to build';
...
600 => "The Commander-position has established itself in modern warfare. Because of the simplified command structure, instructions can be handled faster. With Commander you are able to overview your entire empire! This allows you to develop structures that bring you one step closer to your enemy. ",
601 => 'Geologist is an expert in mining and astro crystallography. Attend their equipment in metallurgy and chemistry and is also responsible for interplanetary communications to optimize the use and refinement of raw material throughout the empire.',
...
600 => 'Empire view, Advertisement free, Building queue, Improved galaxy view, Message filter...',
601 => '+10% mine production ',
602 => 'Max. fleet slots +2',
603 => 'Halves losses to defence systems,<br />+10% energy production',
604 => '+2 espionage levels<br>25% less research time'
);
...
$lang['in_storeage']      					= 'Storage Capacity';
// -------------------------- MINES ------------------------------------------------------------------------------------------------------//
...
$lang['al_delate_ally']                    	= 'They dissolve sure your ally?'; 
//----------------------------------------------------------------------------//
//BUDDY
...
$lang['op_skin_example']					= 'Skins (p.e. C:/ogame/im&aacute;genes/)<br /><a href="http://newgalaxy.com.ar/download/">Download</a>';
...
//----------------------------------------------------------------------------//
//PAYMENT
$lang['pay_intro']				= 'Order Dark Matter';
$lang['pay_form_method']		= 'Select the purchase method';
$lang['pay_welcome_user']		= 'Welcome ';
$lang['pay_metode']				= '!, This is the purchasing system NewGalaxy dark matter then find several purchase options, please select one and follow the instructions.';
$lang['pay_credits_card']		= 'Credits Cards';
$lang['pay_credits_card_intro']	= 'Pay with your credit card from anywhere in the world! Surely your card in available, too!';
$lang['pay_paypal']				= 'Paypal';
$lang['pay_paypal_intro']		= 'Paypal place your order with just 3 clicks THROUGH paypal account without entering your bank details or credit card.';
$lang['pay_sms']				= 'Text Messages (SMS)';
$lang['pay_sms_intro']			= 'Pay fast and without complications way SMS! The sum will be deducted from your next mobile bill.';
$lang['pay_terms']				= 'Terms of Use';
$lang['pay_privacy']			= 'Privacy';
$lang['pay_legal']				= 'Imprint';
$lang['pay_decliner']			= '<font color="#fff"><b>Warning: Your order will be completed to make a new login.
<br> If you have questions or problems regarding payment service please contact http://support.newgalaxy.com.ar.
<br> Your inquiry atendera within 2 business days. <br> You can also help us continue online <br> <br></b></font><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="TBHEPRHHUZSEJ">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
</form>';
$lang['pay_paypal_form']		= 'Payment paypal';
$lang['pay_paypal_others']		= 'others';
$lang['pay_paypal_order_now']	= 'Order Now!';
$lang['pay_paypal_howis']		= 'What is PayPal?';
$lang['pay_paypal_howis_info']	= 'PayPal lets you send payments online
instantly with a bank account,
a credit card or any other
Source. They just wait for
the mail or having to
queue at the bank';
$lang['pay_paypal_fast']		= 'Fast & Safe';
$lang['pay_paypal_fast_info']	= 'PayPal is the fast and secure
to pay online.
You can easily pay your purchases
debit card with the
