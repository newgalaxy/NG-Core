...
class AlliancePage extends bbCode
{
	...
	public function __construct ( $CurrentUser )
	{
		...
		if ( $CurrentUser['ally_id'] != 0 && $CurrentUser['ally_request'] == 0 )
		{
			...
			##############################################################################################
			{
				...
				$lang['ally_description']   = html_entity_decode ( nl2br($this->bbCode($ally['ally_description'])), ENT_COMPAT , "utf-8" );
				$lang['ally_text']          = html_entity_decode ( nl2br($this->bbCode($ally['ally_text'])), ENT_COMPAT , "utf-8" );
				if($ally['ally_web'] != '')
				{
