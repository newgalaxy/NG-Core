...
class TraderPage
{
        function __construct ( $CurrentUser , $CurrentPlanet )
        {
                ...
                if (isset($_POST['ress']) && $_POST['ress'] != '')
                {
                        switch ($_POST['ress'])
                        {
                                case 'metal':
                                {
                                        ...
                                        {
                                                message($lang['tr_must_put_something'], "game.php?page=traderOverview&mode=traderResources",1);
                                        }
                                        elseif ($_POST['cristal'] < 0 or $_POST['deut'] < 0)
                                        {
                                                message($lang['tr_only_positive_numbers'], "game.php?page=traderOverview&mode=traderResources",1);
                                        }
                                        else
                                        {
                                                ...
                                                {
                                                        die ( message ( $storage , 'game.php?page=traderOverview&mode=traderResources' , '2' ) );
                                                }
                                                ...
                                                {
                                                        message($lang['tr_not_enought_metal'], "game.php?page=traderOverview&mode=traderResources",1);
                                                }
                                        }
                                        break;
                                }
                                case 'cristal':
                                {
                                        ...
                                        else
                                        {
                                                ...
                                                {
                                                        message($lang['tr_not_enought_crystal'], "game.php?page=traderOverview&mode=traderResources",1);
                                                }
                                        }
                                        break;
                                }
                                case 'deuterium':
                                {
                                        ...
                                        else
                                        {
                                                ...
                                                {
                                                        message($lang['tr_not_enought_deuterium'], "game.php?page=traderOverview&mode=traderResources",1);
                                                }
                                        }
                                        break;
                                }
                        ...
                        message($lang['tr_exchange_done'],"game.php?page=traderOverview&mode=traderResources",1);
                }
                else
                {
                        if (!$_POST)
				...
				if($CurrentUser['darkmatter'] < TR_DARK_MATTER){
					$parse['boton_trader']   = "<input disabled=\"disabled\" type=\"submit\" value=\"".$lang['tr_call_trader_submit']."\" class=\"trader_submit_off\" style=\"text-align:right;color:#FFF;font-weight:bold;\"/>";
				}
				else{				
					$parse['boton_trader']   = "<input type=\"submit\" value=\"".$lang['tr_call_trader_submit']."\" class=\"trader_submit\" style=\"text-align:right;color:#FFF;font-weight:bold;\"/>";
				}
