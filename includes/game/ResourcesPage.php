		...
		foreach($reslist['prod'] as $ProdID)
		{
			if ($CurrentPlanet[$resource[$ProdID]] > 0 && isset($ProdGrid[$ProdID]))
			{
				...
				if ( $CurrentUser['rpg_geologue'] > 0 ){
					$geologe_bonus = "<img border=\"0\" src=\"styles/images/premium/geologe_ikon.gif\" onmouseover='return overlib(\"<font color=white>".$lang['rs_geologist_bonus']."</font>\", WIDTH, 150);' onmouseout='return nd();' width=\"20\" height=\"20\">";
				}else{
					$geologe_bonus = "";
				}
				if ( $CurrentUser['rpg_ingenieur'] > 0 ){
					$engineer_bonus = "<img border=\"0\" src=\"styles/images/premium/ingenieur_ikon.gif\" onmouseover='return overlib(\"<font color=white>".$lang['rs_engineer_bonus']."</font>\", WIDTH, 150);' onmouseout='return nd();' width=\"20\" height=\"20\">";
				}else{
					$engineer_bonus = "";
				}
				/*Fin Officiers Improves*/
				...
				if ( $ProdID >=   1 && $ProdID <=   3 )
					$CurrRow['officiers_type']	= $geologe_bonus;
				elseif ( $ProdID >= 4 && $ProdID <=  12 OR $ProdID ==  212)	
					$CurrRow['officiers_type']	= $engineer_bonus;
				else
					$CurrRow['officiers_type']	= '';
				/*Fin Officiers Improves*/
