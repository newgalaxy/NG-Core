...
function display ($page, $topnav = TRUE, $metatags = '', $AdminPage = FALSE, $menu = TRUE)
{
	...
	if ($menu && !$AdminPage)
	{
		include_once(XGP_ROOT . 'includes/functions/ShowRightMenu.php');
		$DisplayPage .= ShowRightMenu ($user);
	}
...
{		
	...
	$parse['favicon']	 = "<link rel=\"shortcut icon\" href=\"".LOGIN_DIR."favicon.png\" type=\"image/png\" />";
	
	if(!defined('LOGIN'))
	{
		$parse['css']  	 	    = "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/default.css\">\n";
		$parse['css']  		   .= "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/ingame.css?v=".CSS_VERSION."\">\n";
		$parse['css'] 		   .= "<link rel=\"stylesheet\" type=\"text/css\" href=\"". DPATH ."formate.css?v=".CSS_VERSION."\"/>\n";
		$parse['ingame_js']		= "<script type=\"text/javascript\" src=\"js/overlib-min.js\"></script>";
		$parse['game_jquery']   = "<script type=\"text/javascript\" src=\"js/jquery-2.0.1.min.js\"></script>";
		
		$page = gettemplate( ( 'general/simple_header' ) , $parse );
	}
	else
	{
		$parse['title_login']    = read_config ( 'game_name' );
		$parse['language']		 = read_config ( 'lang' );
		
		$parse['favicon_login']	 = "<link rel=\"shortcut icon\" href=\"".LOGIN_DIR."favicon.png\" type=\"image/png\" />";
		$parse['Apple_52']	     = "<link rel=\"apple-touch-icon-precomposed\" sizes=\"57x57\" href=\"".LOGIN_DIR."ico/apple-touch-icon-57-precomposed.png\">";
		$parse['Apple_72']	     = "<link rel=\"apple-touch-icon-precomposed\" sizes=\"72x72\" href=\"".LOGIN_DIR."ico/apple-touch-icon-72-precomposed.png\">";
		
		$parse['bootstrap']      = "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/login/bootstrap.css\">";
		$parse['bootstrap-res']  = "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/login/bootstrap-responsive.css\">";
		$parse['style_login']  	 = "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/Login-NG.css\">";
		$parse['style']  	     = "<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/css/styles.css\">\n";
		$parse['meta']		     = ($metatags) ? $metatags : "";
		
		$page = gettemplate( ( 'public/index_header' ) , $parse );
	}

	$parse['meta']	.= ($metatags) ? $metatags : "";

	return parsetemplate (( $page ) , $parse );
}
