...
function contar(textareaid,charcountid) {
  n = document.getElementById(textareaid).value.length;
  t = 5000; //Maximos caracteres
  if (n > t) {
    document.getElementById(textareaid).value = document.getElementById(textareaid).value.substring(0, t);
  }
  else {
    document.getElementById(charcountid).value = t-n;
  }
}

//Ventana de seleccion de color
function colorshow(name,textid,hidid){
var way;
way = document.getElementById(hidid).value;
	if (way == "1")
	{
		window.open("ShowAllyColourSel.php",name,"toolbar=0, location=0, directories=0, status=0, menubar=0, scrollbars=0, resizable=0, width=800, height=700, top=60, left=100");
	}
	if(way == "2")
	{
	...
	if (way == "3")
	{
	document.getElementById(textid).value += '[color=][/color]';
	}
	
}	

//negrita
function addbold(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		...
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
		document.getElementById(textid).value += '[/b]';  
	...
	if (way == "3") { document.getElementById(textid).value += '[b][/b]'; }
}

// cursiva
function addcursive(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	...
	if (way == "3") { document.getElementById(textid).value += '[i][/i]'; }
}

// subrayado
function addunderline(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[u]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[u][/u]'; }
}

//quote ([quote]...[/quote]
function addquote(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[quote]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[quote][/quote]'; }
}

// codigo ([code] ... [/code]
function addcode(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[code]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[code][/code]'; }
}
//url [url=URL]Texto[/url]
function addurl(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[url=http://]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[url=http://][/url]'; }
}

//lista ([list] ... [/list]
function addlist(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[list]\n[*]\n[*]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[list][/list]'; }
}

//Imagen ([img] ... [/img]
function addimg(textid,hidid) 
{
	var way;
	way = document.getElementById(hidid).value;
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[img]'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
	...
	if (way == "3") { document.getElementById(textid).value += '[img][/img]'; }
}

//Letra ([size=] ... [/size]
function moresize(textid,hidid,sizeid) 
{
	var way;
	var size;
	size = document.getElementById(sizeid).value;
	
	//Se que esto que viene es una tontería, pero si no, no lo acepta
if (size <= 6){size = 8}
if (size == 8){size = 10}
if (size == 10){size = 12}
if (size == 12){size = 14}
if (size >= 14){size = 16}
	...
	if (way == "1" ) 
	{ 
		document.getElementById(textid).value += '[size='+size+']'; 
		document.getElementById(hidid).value = '2';
	}
	if (way == "2") 
	{
		document.getElementById(textid).value += '[/size]';  
		document.getElementById(hidid).value = '1';
	}
	if (way == "3") { document.getElementById(textid).value += '[size=][/size]'; }
}
//Letra ([size=] ... [/size]
function decreasesize(textid,hidid,sizeid) 
{
	var way;
	var size;
	size = document.getElementById(sizeid).value;
